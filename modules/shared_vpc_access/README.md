...
| gke\_shared\_vpc\_security\_admin\_role\_enabled | Whether or not to grant Kubernetes Engine Service Agent the Security Admin role on the host project so it can manage firewall rules | `bool` | `false` | no |
