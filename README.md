...
| random\_project\_id | Adds a suffix of 4 random characters to the `project_id`. Once you delete a project you can't use the same `project_id` for 30 days. It is useful for testing since it allows you to create and shut down projects without worrying about conflicts. | `bool` | `false` | no |
