...
output "service_project_name" {
  value       = module.host_project.service_project.project_name
  description = "The service project name"
}

output "service_project_id" {
  value       = module.host_project.service_project.project_id
  description = "The service project ID"
}

output "service_project_ids" {
  value = [
    module.host_project.service_project.project_id,
    module.host_project.service_project_b.project_id
  ]
  description = "The service project IDs"
}

output "service_project_number" {
  value       = module.host_project.service_project.project_number
  description = "The service project number"
}

output "service_project_b_number" {
  value       = module.host_project.service_project_b.project_number
  description = "The service project b number"
}

output "service_account_email" {
  value       = module.host_project.service_project.service_account_email
  description = "The service account email"
}

output "secondary_service_account_email" {
  value       = module.host_project.service_project_b.service_account_email
  description = "The secondary service account email"
}

output "shared_vpc" {
  value       = module.host_project.host_project.project_id
  description = "The host project ID"
}

output "shared_vpc_subnet_name_01" {
  value       = module.host_project.vpc.subnets_names[0]
  description = "The first subnet name"
}

output "shared_vpc_subnet_region_01" {
  value       = module.host_project.vpc.subnets_regions[0]
  description = "The first subnet region"
}

output "shared_vpc_subnet_name_02" {
  value       = module.host_project.vpc.subnets_names[1]
  description = "The second subnet name"
}

output "shared_vpc_subnet_region_02" {
  value       = module.host_project.vpc.subnets_regions[1]
